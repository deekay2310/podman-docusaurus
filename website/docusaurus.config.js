...
const config = {
  title: 'Manage pods, containers, and container images',
  ...
  projectName: 'podman.io', // Usually your repo name.
        ...
        links: [
          {
            ...
            items: [
              {
                label: 'Getting Started with Podman',
